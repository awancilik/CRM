...
{
    [Serializable]
    public class TicketHistory : BusinessBase<TicketHistory>
    {
        ...
        {
            get { return GetProperty(UpdateCommandProperty); }
            set { SetProperty(UpdateCommandProperty, value); }
        }
        ...
        public static TicketHistory NewTicket()
        {
            TicketHistory obj = DataPortal.Create<TicketHistory>();
            return obj;
        }

        public static TicketHistory GetTicket(long idticket)
        {
            TicketHistory obj = DataPortal.Fetch<TicketHistory>(idticket);
            if (obj.idticket == 0)
            {
                return null;
            }
        ...
        public static TicketHistory GetTicket(string ticketNo)
        {
            TicketHistory obj = DataPortal.Fetch<TicketHistory>(ticketNo);
            if (obj.idticket == 0)
            {
                return null;
            }
        ...
        public static TicketHistory GetTicket(SafeDataReader dr)
        {
            return DataPortal.Fetch<TicketHistory>(dr);
        }

        public static void DeleteTicket(long idticket)
        {
            DataPortal.Delete<TicketHistory>(idticket);
        }
        ...
        private void DataPortal_Fetch(string ticketNo)
        {
            ...
            {
                MySqlCommand cm = ctx.CreateSelectCommand();
                cm.CommandText = "SELECT idticket, TicketNo, TicketSubject, Requester, CallerPosistion, Priority, TicketOwner, TicketType, TicketStatus, TicketDescription, Solution, Escalation, CreatedBy, CreatedDate, UpdatedBy, UpdatedDate, UpdateCommand  FROM ticket_his WHERE TicketNo=@TicketNo";
        ...
        protected override void DataPortal_Insert()
        {
            using (DatabaseManager ctx = new DatabaseManager())
            {
                ...
                cm.CommandText = "INSERT INTO ticket_his(TicketNo, TicketSubject, Requester, CallerPosistion, Priority, TicketOwner, TicketType, TicketStatus, TicketDescription, Solution, Escalation, CreatedBy, CreatedDate, UpdatedBy, UpdatedDate, UpdateCommand ) VALUES (@TicketNo, @TicketSubject, @Requester, @CallerPosistion, @Priority, @TicketOwner, @TicketType, @TicketStatus, @TicketDescription, @Solution, @Escalation, @CreatedBy, @CreatedDate, @UpdatedBy, @UpdatedDate, @UpdateCommand )";
                DoCommand(cm);
        ...
        protected override void DataPortal_Update()
        {
            ...
            {
                MySqlCommand cm = ctx.CreateCommand();
                cm.CommandText = "UPDATE ticket_his SET TicketNo=@TicketNo, TicketSubject=@TicketSubject, Requester=@Requester, CallerPosistion=@CallerPosistion, Priority=@Priority, TicketOwner=@TicketOwner, TicketType=@TicketType, TicketStatus=@TicketStatus, TicketDescription=@TicketDescription, Solution=@Solution, Escalation=@Escalation, CreatedBy=@CreatedBy, CreatedDate=@CreatedDate, UpdatedBy=@UpdatedBy, UpdatedDate=@UpdatedDate, UpdateCommand=@UpdateCommand  WHERE idticket=@idticket";
        ...
        private void DataPortal_Delete(long id)
        {
            ...
            {
                MySqlCommand cm = ctx.CreateCommand();
                cm.CommandText = "DELETE FROM ticket_his WHERE idticket=@idticket";
                cm.Parameters.AddWithValue("@idticket", idticket);
                cm.ExecuteNonQuery();
            }
        }
        ...
        private void DataPortal_Fetch(SafeDataReader dr)
        {
            ...
            SetProperty(UpdateCommandProperty, dr.GetString(16));
        }
        ...
        private int DoCommand(MySqlCommand cm)
        {
            ...
            cm.Parameters.AddWithValue("@UpdateCommand", UpdateCommand);
