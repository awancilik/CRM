...
namespace ISAT.Web.ViewModel
{
    public class Ticket
    {
        ...
        public Ticket(ISAT.Business.Ticket ticket, ISAT.Business.Customer cust)
        {
        ...
        public static ISAT.Business.Ticket ConvertToTicketBusiness(Ticket m)
        {
            ISAT.Business.Ticket obj = ISAT.Business.Ticket.GetTicket(m.TicketNo);
            if (obj == null)
            {
                obj = ISAT.Business.Ticket.NewTicket(); 
            }
